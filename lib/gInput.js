...
var gInput = {
  ...
  'generateTestCase':function (arrayOfTestCaseValidation){
  ...
  'generateInputRecord':function (inputConfig){
    ...
    // console.log(arrayOfNormalTestCaseValidation);

    // Current Status
    // {
    //  '[name=\'name\']': [ '^required', '^between:8,20' ],
    //  '[name=\'email\']': [ 'required', 'email', 'unique:users,email' ],
    //  '[name=\'password\']': [ 'required', 'min:8' ]
    // }

    // generate input from that specified validation
