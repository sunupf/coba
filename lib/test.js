...
Test.prototype.openBrowser = function () {
  ...
  var loadingTime = (this.loadTime - this.startTime ) / 1000

  console.log(loadingTime + " s")
};

Test.prototype.fillInputForm = function () {
  var tempDriver = this.driver
  var tempBy = this.By
  this._.each(this.config.input,function(input,index){
    tempDriver.findElement(tempBy.cssSelector(input.selector)).sendKeys('Sunu Pinasthika Fajar');
